...
export class BlogDetail extends React.Component {
    ...
    // Used wordpress APi and used bolg it to fetch blog details
    componentDidMount() {
        let blogId = this.props.navigation.getParam('blogId', 'NO BLOG');
        return fetch(`https://public-api.wordpress.com/rest/v1.1/sites/eashinblog.wordpress.com/posts/${blogId}`)
